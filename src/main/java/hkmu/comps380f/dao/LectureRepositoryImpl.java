...
public class LectureRepositoryImpl implements LectureRepository { 
        ...
        public List<Lecture> extractData(ResultSet rs) throws SQLException, DataAccessException { 
            ...
            while (rs.next()) { 
                ...
                if (lecture == null) { 
                    lecture = new Lecture(); 
                    lecture.setId(id); 
                    lecture.setLecturerName(rs.getString("name")); 
    ...
    @Override 
    @Transactional 
    public long createLecture(final String lecturerName, final String subject,  
    ...
    public List<Lecture> getLectures() {
        final String SQL_SELECT_LECTURES = "select t.*, a.filename, a.content_type," 
    ...
    public List<Lecture> getLecture(long id) { 
        final String SQL_SELECT_LECTURE = "select t.*, a.filename, a.content_type," 
                + " a.content from lecture as t left join attachment as a" 
